...
const NewsLetter = () => {
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center space-y-2 pt-8 pb-14 transition-all duration-500
    ? "bg-white shadow-lg" : "bg-gradient-to-r from-indigo-900 to-purple-800"
    }`}>
      <h1 className="md:text-4xl text-2xl font-medium text-black">
        Subscribe now & get 20% off
      </h1>
      <p className="md:text-base text-black pb-8">
